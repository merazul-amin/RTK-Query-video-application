...
export default function Form({ video }) {
    ...
    const { title: initialTitle, author: initialAuthor, description: initialDescription, date: initialDate, duration: initialDuration, link: initialLink, thumbnail: initialThumbnail, views: initialViews, id } = video || {};
    ...
    const handleSubmit = (e) => {
        ...
        editVideo({
            id: id,
            data: {
                title, description, author, link, thumbnail, date, duration, views
            }
        })
    }
